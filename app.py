...
# Defaults for Dispo Rep filter (must exist before we use them)
rep_active = False
dispo_rep_choice = "All reps"
...
df_sold_buyers, buyer_count_by_county, buyers_set_by_county = compute_buyer_context_from_df(df_time_sold_for_view)
