...
from admin_view import require_sales_manager_auth, render_sales_manager_dashboard
from app_sections import compute_buyer_context_from_df
...
df_sold_buyers = (
    df_time_sold_for_view.copy()
    if team_view in ["Dispo", "Admin"]
    else fd.df_time_sold.copy()
)

df_sold_buyers, buyer_count_by_county, buyers_set_by_county = compute_buyer_context_from_df(df_sold_buyers)
